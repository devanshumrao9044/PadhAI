...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  sheet: { minHeight: '78%', maxHeight: '92%', backgroundColor: colors.surface, borderTopLeftRadius: Radius.xl, borderTopRightRadius: Radius.xl, paddingHorizontal: Spacing.md, paddingTop: Spacing.sm, paddingBottom: Spacing.lg, borderWidth: 1, borderColor: colors.border },
  ...
  headerTitle: { color: colors.textPrimary, fontSize: FontSize.lg, fontWeight: FontWeight.extraBold },
  ...
  pageContent: { flex: 1, alignItems: 'center', paddingHorizontal: Spacing.md, paddingTop: Spacing.md },
  ...
  pageTitleRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: Spacing.sm, marginBottom: Spacing.md },
  pageTitle: { color: colors.primary, fontSize: FontSize.xxl, fontWeight: FontWeight.extraBold, textAlign: 'center', flexShrink: 1 },
  pageBodyText: { color: colors.textSecondary, fontSize: FontSize.md, lineHeight: 25, textAlign: 'center' },
  ...
  zoneCard: { flexDirection: 'row', alignItems: 'flex-start', gap: Spacing.sm, padding: Spacing.sm, borderRadius: Radius.md, borderWidth: 1, borderColor: colors.border },
  zoneCopy: { flex: 1 },
  zoneTitle: { color: colors.textPrimary, fontSize: FontSize.base, fontWeight: FontWeight.bold, marginBottom: 2 },
  zoneBody: { color: colors.textSecondary, fontSize: FontSize.sm, lineHeight: 19 },
