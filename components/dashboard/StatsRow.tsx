...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  card: { flex: 1, minWidth: 0, minHeight: 112, justifyContent: 'center', backgroundColor: colors.surface, borderRadius: 16, paddingHorizontal: 8, paddingVertical: 14, alignItems: 'center', borderWidth: 1, borderColor: colors.border },
  emoji: { fontSize: 21, marginBottom: 7 },
  value: { color: colors.textPrimary, fontSize: 15, lineHeight: 20, fontWeight: '800', marginBottom: 3, textAlign: 'center', flexShrink: 1 },
  label: { color: colors.textSecondary, fontSize: 11, lineHeight: 16, textAlign: 'center', flexShrink: 1 },
  progressContainer: { backgroundColor: colors.surface, borderRadius: 16, padding: 16, borderWidth: 1, borderColor: colors.border, shadowColor: '#000000', shadowOpacity: 0.05, shadowRadius: 8, shadowOffset: { width: 0, height: 3 }, elevation: 1 },
  ...
  progressTrack: { height: 10, backgroundColor: colors.surfaceVariant, borderRadius: 5, overflow: 'hidden', borderWidth: 1, borderColor: colors.border },
  progressFill: { height: '100%', minWidth: 4, borderRadius: 5 },
});
