-- Return current authoritative XP/streak totals on idempotent duplicate replay.
-- No reward calculation or client write permission is changed.
...
BEGIN
  ...
  IF FOUND THEN
    ...
    END IF;
    SELECT COALESCE(u.xp, 0), COALESCE(u.streak, 0)
