-- Referral codes are permanent. Remove the optional expiration field and restore
-- validation so only normalization, existence, and self-referral rules apply.

DROP FUNCTION IF EXISTS public.get_referrer_id(text);
...
ALTER TABLE public.users
  DROP COLUMN IF EXISTS referral_code_expires_at;
