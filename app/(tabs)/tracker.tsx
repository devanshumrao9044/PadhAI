              ...
              <View style={styles.cardInfo}>
                <View style={[styles.subjectDot, { backgroundColor: item.colorHex || colors.primary }]}>
                  ...
                  <View style={styles.subjectCopy}>
                    ...
                    <Text style={styles.timerText}>{t('tracker.openFocus')}</Text>
                  </View>
              </View>
              <View style={styles.subjectActions}>
                <TouchableOpacity
                  style={[styles.playBtn, { backgroundColor: item.colorHex || colors.primary }]}
                  onPress={() => router.push({ pathname: '/(tabs)/focus', params: { subjectId: item.id } } as any)}
                  accessibilityLabel={t('tracker.startTimer')}
                >
                  <MaterialIcons name="play-arrow" size={19} color={colors.background} />
                </TouchableOpacity>
