...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'flex-start', paddingHorizontal: Spacing.md, paddingVertical: Spacing.md, gap: 10 },
  backButton: { flexShrink: 0, width: 38, height: 38, alignItems: 'center', justifyContent: 'center' },
  headerCopy: { flex: 1, minWidth: 0 },
  title: { color: colors.textPrimary, fontSize: FontSize.xl, lineHeight: 28, fontWeight: FontWeight.bold, flexShrink: 1 },
  ...
  contentHeader: { flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', gap: 8, paddingHorizontal: Spacing.md, paddingVertical: Spacing.sm },
  ...
  countText: { maxWidth: '40%', color: colors.primary, fontSize: FontSize.sm, lineHeight: 18, fontWeight: FontWeight.semiBold, textAlign: 'right', flexShrink: 1 },
  ...
  taskTitle: { color: colors.textPrimary, fontSize: FontSize.base, lineHeight: 20, fontWeight: FontWeight.semiBold, flexShrink: 1 },
  taskCompleted: { textDecorationLine: 'line-through', color: colors.textTertiary },
  taskMeta: { color: colors.textSecondary, fontSize: FontSize.xs, lineHeight: 17, marginTop: 4, flexShrink: 1 },
  deleteButton: { padding: 4 },
  empty: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: Spacing.xl, gap: Spacing.sm },
  emptyTitle: { color: colors.textPrimary, fontSize: FontSize.lg, lineHeight: 24, fontWeight: FontWeight.bold, textAlign: 'center', flexShrink: 1 },
  emptyText: { color: colors.textSecondary, fontSize: FontSize.sm, lineHeight: 19, textAlign: 'center', flexShrink: 1 },
  ...
  subjectChipText: { maxWidth: 160, color: colors.textSecondary, fontSize: FontSize.sm, lineHeight: 18, flexShrink: 1 },
  ...
  saveButtonText: { color: colors.background, fontSize: FontSize.md, lineHeight: 22, fontWeight: FontWeight.bold, textAlign: 'center', flexShrink: 1 },
  ...
  confirmTitle: { color: colors.textPrimary, fontSize: FontSize.lg, lineHeight: 24, fontWeight: FontWeight.bold, marginBottom: 6, flexShrink: 1 },
  confirmText: { color: colors.textSecondary, fontSize: FontSize.base, lineHeight: 21, marginBottom: Spacing.lg },
  confirmActions: { flexDirection: 'row', gap: 10, flexWrap: 'wrap' },
  cancelButton: { flex: 1, minWidth: 120, backgroundColor: colors.surfaceVariant, borderRadius: Radius.md, paddingVertical: 12, alignItems: 'center' },
  cancelButtonText: { color: colors.textSecondary, fontWeight: FontWeight.semiBold },
  deleteConfirmButton: { flex: 1, minWidth: 120, backgroundColor: colors.danger, borderRadius: Radius.md, paddingVertical: 12, alignItems: 'center' },
