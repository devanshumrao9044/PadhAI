...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, paddingHorizontal: Spacing.md, paddingVertical: Spacing.sm, borderBottomWidth: 1, borderBottomColor: colors.border },
  backButton: { flexShrink: 0, width: 42, height: 42, borderRadius: 21, alignItems: 'center', justifyContent: 'center' },
  refreshButton: { flexShrink: 0, width: 42, height: 42, borderRadius: 21, alignItems: 'center', justifyContent: 'center' },
  headerText: { flex: 1, minWidth: 0 },
  title: { color: colors.textPrimary, fontSize: FontSize.xl, lineHeight: 28, fontWeight: FontWeight.bold, flexShrink: 1 },
  subtitle: { color: colors.textSecondary, fontSize: FontSize.xs, lineHeight: 17, marginTop: 2, flexShrink: 1 },
  ...
  iconWrap: { flexShrink: 0, width: 36, height: 36, borderRadius: 18, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surfaceVariant },
  itemBody: { flex: 1, minWidth: 0 },
  itemHeader: { flexDirection: 'row', alignItems: 'flex-start', gap: Spacing.xs },
  itemTitle: { flex: 1, minWidth: 0, color: colors.textPrimary, fontSize: FontSize.base, lineHeight: 20, fontWeight: FontWeight.bold, flexShrink: 1 },
  unreadDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: colors.primary },
  itemMessage: { color: colors.textSecondary, fontSize: FontSize.sm, lineHeight: 20, marginTop: 4 },
  itemDate: { color: colors.textTertiary, fontSize: FontSize.xs, lineHeight: 17, marginTop: 8, flexShrink: 1 },
  markRead: { color: colors.primary, fontSize: FontSize.xs, lineHeight: 17, fontWeight: FontWeight.semiBold, marginTop: 5, flexShrink: 1 },
  linkInfo: { flexDirection: 'row', alignItems: 'flex-start', gap: 4, marginTop: Spacing.sm, paddingLeft: 44 },
  linkText: { flex: 1, minWidth: 0, color: colors.textSecondary, fontSize: FontSize.xs, lineHeight: 17, flexShrink: 1 },
