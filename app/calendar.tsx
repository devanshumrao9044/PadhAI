...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  eventsHeader: { flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', gap: 8, paddingHorizontal: Spacing.md, paddingVertical: Spacing.md },
  ...
  eventTitle: { color: colors.textPrimary, fontSize: FontSize.base, lineHeight: 20, fontWeight: FontWeight.semiBold, flexShrink: 1 },
  eventMeta: { color: colors.textSecondary, fontSize: FontSize.xs, lineHeight: 17, marginTop: 3, flexShrink: 1 },
  ...
  switchHint: { color: colors.textSecondary, fontSize: FontSize.xs, lineHeight: 17, marginTop: 3, flexShrink: 1 },
